...
from alphafold.train.utils import crop_and_pad_multimer
...
def train(train_config):
  ...
  batch = crop_and_pad_multimer(batch, 256, 181129)
  batch['resolution'] = 2
  import jax.random as jrand
  update_rng = jrand.PRNGKey(0)
  trainer.initialize(batch, load_format=gc.ckpt_format)
